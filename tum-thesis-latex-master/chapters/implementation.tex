...
\begin{figure}[h]
\includegraphics[width=0.8\textwidth, inner, center]{deployment}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.6\textwidth}
        \includegraphics[width=\textwidth]{homeLD}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{homeSD}
...
\begin{figure}
    \centering
    \begin{subfigure}[b]{0.6\textwidth}
        \includegraphics[width=\textwidth]{detailsLD}
    ...
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
      %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{swipeleftSD}
...
\begin{figure}
    \centering
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{playSDb}
    ...
    %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{playSDd}
