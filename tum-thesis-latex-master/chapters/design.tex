...
\begin{figure}[h!]
\includegraphics[width=0.9\textwidth, inner, center]{figures/generic3}
...
\begin{figure}[h!]
\includegraphics[width=0.9\textwidth, inner, center]{figures/generic4}
...
\begin{figure}[h!]
\includegraphics[width=0.9\textwidth, inner, center]{figures/generic5}
...
\begin{figure}[h!]
\includegraphics[width=0.6\textwidth, inner, center]{figures/env}
...
\begin{figure}[h!]
\includegraphics[width=0.85\textwidth, inner,
...
\begin{figure}[h!]
\includegraphics[width=0.9\textwidth, inner, center]{figures/playrate}
...
\begin{figure}[h!]
\includegraphics[width=0.85\textwidth, inner, center]{figures/filtering}
